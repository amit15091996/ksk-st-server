...
public interface StockDetailsRepository extends JpaRepository<StockDetails, Long> {
	...
	public void updateStockDetals(@Param("stockName") String stockName, @Param("stockCategory") String stockCategory,
			@Param("stockQuantity") int stockQuantity, @Param("stockUnit") String stockUnit,
			@Param("stockPrice") double stockPrice, @Param("totalStockAmount") double totalStockAmount,
	...
	public void updateStockDetalsOnSales(@Param("stockQuantity") int stockQuantity,
			@Param("totalStockAmount") double totalStockAmount, @Param("stockId") Long stockId);
