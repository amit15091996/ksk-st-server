...
public class StockDetailsServiceImpl implements StockDetailsService {
	...
	public Map<Object, Object> updateStockDetails(Long stockId, StockDetailsDto stockDetailsDto) {
		...
		if (this.stockDetailsRepository.findById(stockId).isPresent()) {
			try {
				this.stockDetailsRepository.updateStockDetals(stockDetailsDto.getStockName(),
						stockDetailsDto.getStockCategory(), stockDetailsDto.getStockQuantity(),
						stockDetailsDto.getStockUnit(), stockDetailsDto.getStockPrice(),
						stockDetailsDto.getStockPrice() * stockDetailsDto.getStockQuantity(), stockId);
