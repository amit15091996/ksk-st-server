...
public class InventoryController {
	...
	public ResponseEntity<Map<Object, Object>> saveLedgerDetails(
			@RequestBody @Valid LedgerDetailsDto ledgerDetailsDto) {
	...
	public ResponseEntity<Map<Object, Object>> updateLedgerDetails(@PathVariable(name = "ledgerId") Long ledgerId,
			@RequestBody @Valid LedgerDetailsDto ledgerDetailsDto) {
	...
	public ResponseEntity<Map<Object, Object>> getLedgerDataByCustomerName(
	...
	public ResponseEntity<Map<Object, Object>> updateStockDetails(@PathVariable(name = "stockId") Long stockId,
			@RequestBody @Valid StockDetailsDto stockDetailsDto) {
	...
	public ResponseEntity<Map<Object, Object>> saveInventoryItem(
			@RequestBody @Valid InventoryItemDto inventoryItemDto) {
	...
	public ResponseEntity<Map<Object, Object>> updateInventoryItem(@PathVariable(name = "inventoryId") Long inventoryId,
			@RequestBody @Valid InventoryItemDto inventoryItemDto) {
	...
	public ResponseEntity<Map<Object, Object>> deleteInventoryItem(
	...
	public ResponseEntity<Map<Object, Object>> updateSalesRecord(@PathVariable(name = "soldItemId") Long soldItemId,
			@RequestBody @Valid SalesRecordDto salesRecordDto) {
	...
	public ResponseEntity<Map<Object, Object>> updatePurchaseRecord(
			@PathVariable(name = "purchasedItemId") Long purchasedItemId,
			@RequestBody @Valid PurchaseRecordDto purchaseRecordDto) {
	...
	public ResponseEntity<Map<Object, Object>> deletePurchaseRecord(
			@PathVariable(name = "purchasedItemId") Long purchasedItemId) {
	...
	public ResponseEntity<Map<Object, Object>> saveRecieptRecord(@PathVariable("soldItemId") Long soldItemId,
			@RequestBody @Valid RecieptsRecordDto recieptsRecordDto) {
	...
	public ResponseEntity<Map<Object, Object>> updateRecieptRecord(@PathVariable(name = "recieptId") Long recieptId,
			@RequestBody @Valid RecieptsRecordDto recieptsRecordDto) {
	...
	public ResponseEntity<Map<Object, Object>> savePaymentRecord(@PathVariable("purchasedItemId") Long purchasedItemId,
			@RequestBody @Valid PyamentsRecordDto pyamentsRecordDto) {
	...
	public ResponseEntity<Map<Object, Object>> updatePaymentRecord(@PathVariable(name = "paymentId") Long paymentId,
			@RequestBody @Valid PyamentsRecordDto pyamentsRecordDto) {
	...
	public ResponseEntity<Map<Object, Object>> getAllSalesRecordViaPartyName(
			@PathVariable("partyName") String partyName) throws JsonMappingException, JsonProcessingException {
	...
	public ResponseEntity<Map<Object, Object>> uploadFileToGoogleDrive(
